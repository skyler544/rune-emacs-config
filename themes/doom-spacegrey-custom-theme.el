;;; doom-spacegrey-custom-theme.el --- inspired by Atom Spacegrey-Custom Dark -*- lexical-binding: t; no-byte-compile: t; -*-
(require 'doom-themes)

(defgroup doom-spacegrey-custom-theme nil
  "Options for the `doom-spacegrey-custom' theme."
  :group 'doom-themes)

(defcustom doom-spacegrey-custom-brighter-modeline nil
  "If non-nil, more vivid colors will be used to style the mode-line."
  :group 'doom-spacegrey-custom-theme
  :type 'boolean)

(defcustom doom-spacegrey-custom-brighter-comments nil
  "If non-nil, comments will be highlighted in more vivid colors."
  :group 'doom-spacegrey-custom-theme
  :type 'boolean)

(defcustom doom-spacegrey-custom-comment-bg doom-spacegrey-custom-brighter-comments
  "If non-nil, comments will have a subtle, darker background. Enhancing their
legibility."
  :group 'doom-spacegrey-custom-theme
  :type 'boolean)

(defcustom doom-spacegrey-custom-padded-modeline doom-themes-padded-modeline
...
(def-doom-theme doom-spacegrey-custom
  "A dark theme inspired by Atom Spacegrey-Custom Dark"

  ;; name        default   256       16
  ((bg         '("#2C3436" nil       nil            ))
   (bg-alt     '("#252C2E" nil       nil            ))
   ...
   (selection      base4)
   (builtin        orange)
   (comments       (if doom-spacegrey-custom-brighter-comments dark-cyan base5))
   (doc-comments   (doom-lighten (if doom-spacegrey-custom-brighter-comments dark-cyan base5) 0.25))
   (constants      orange)
   (functions      blue)
   (keywords       violet)
   (methods        blue)
   ...
   (-modeline-bright doom-spacegrey-custom-brighter-modeline)
   (-modeline-pad
    (when doom-spacegrey-custom-padded-modeline
      (if (integerp doom-spacegrey-custom-padded-modeline) doom-spacegrey-custom-padded-modeline 4)))
  ...
  (((font-lock-comment-face &override)
    :background (if doom-spacegrey-custom-comment-bg (doom-lighten bg 0.05)))
...
;;; doom-spacegrey-custom-theme.el ends here
