;;; doom-henna-custom-theme.el --- inspired by vscode henna-custom theme -*- lexical-binding: t; no-byte-compile: t; -*-
(require 'doom-themes)

;;; Code:
(defgroup doom-henna-custom-theme nil
  "Options for the `doom-henna-custom' theme."
  :group 'doom-themes)

(defcustom doom-henna-custom-brighter-modeline nil
  "If non-nil, more vivid colors will be used to style the mode-line."
  :group 'doom-henna-custom-theme
  :type 'boolean)

(defcustom doom-henna-custom-brighter-comments nil
  "If non-nil, comments will be highlighted in more vivid colors."
  :group 'doom-henna-custom-theme
  :type 'boolean)

(defcustom doom-henna-custom-comment-bg doom-henna-custom-brighter-comments
  "If non-nil, comments will have a subtle, darker background. Enhancing their
legibility."
  :group 'doom-henna-custom-theme
  :type 'boolean)

(defcustom doom-henna-custom-padded-modeline doom-themes-padded-modeline
...
;;
(def-doom-theme doom-henna-custom
  ...
  ((bg         '("#2C3436" nil       nil            ))
   ...
   ;; Not used, so remap to other (henna-custom) colors
   (orange     red)
   ...
   (-modeline-bright doom-henna-custom-brighter-modeline)
   (-modeline-pad
    (when doom-henna-custom-padded-modeline
      (if (integerp doom-henna-custom-padded-modeline) doom-henna-custom-padded-modeline 4)))
  ...
  (((font-lock-comment-face &override)
    :background (if doom-henna-custom-comment-bg (doom-lighten bg 0.05)))
...
;;; doom-henna-custom-theme.el ends here
