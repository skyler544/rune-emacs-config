;; doom-sourcerer-alt-theme.el -*- lexical-binding: t; no-byte-compile: t; -*-
;;; Commentary:
(require 'doom-themes)
;;; Code:
;;
...
(def-doom-theme doom-sourcerer-alt
  "A dark theme based off of xero's Sourcerer-Alt VIM colorscheme"
  ...
  ((bg         '("#232829"))
   ...
   (selection      base5)
   (builtin        blue)
   (comments       (if doom-sourcerer-alt-brighter-comments dark-cyan grey))
   (doc-comments   (if doom-sourcerer-alt-brighter-comments (doom-lighten dark-cyan 0.15) (doom-darken grey 0.1)))
   (constants      teal)
   (functions      base8)
   (keywords       blue)
   (methods        magenta)
